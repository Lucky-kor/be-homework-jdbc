...
public class MemberController {
    ...
    public ResponseEntity getMembers(@RequestParam("page") @Positive int page,
        ...
        MembersResponseDto.PageInfo pageInfo = MembersResponseDto.PageInfo.builder()
                .page(page)
                .size(size)
                .totalElements((int) pageMember.getTotalElements())
                .build();

        List<MemberResponseDto> response = mapper.membersToMemberResponseDtos((List<Member>) pageMember);
