...
public class MemberController {
    ...
    @GetMapping
    public ResponseEntity getMembers(@Positive(message = "page는 0보다 큰 숫자만 가능합니다.")
                                     @RequestParam(value = "page", defaultValue = "1") int page,
                                     @Positive(message = "size는 0보다 큰 숫자만 가능합니다.")
        ...
        MultiResponseDto response = new MultiResponseDto<>(responseDto, pageMembers);
